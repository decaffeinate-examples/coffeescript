...
test("object keys with interpolations", function() {
  // Simple cases.
  let ref;
  const a = 'a';
  obj = {[a]: true};
...
test("#4324: Shorthand after interpolated key", function() {
  const a = 2;
  obj = {[1]: 1, a};
  eq(1, obj[1]);
  return eq(2, obj.a);
...
test("#1263: Braceless object return", function() {
  const fn = () => ({
    a: 1,
    b: 2,
    c() { return 3; }
