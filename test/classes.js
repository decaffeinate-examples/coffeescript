  ...
  class ThirdChild extends SecondChild {
    constructor() {
      { // Hack: trick Babel/TypeScript into allowing this before super.
        if (false) { super(); } const thisFn = (() => this).toString(); const thisName = thisFn.match(/return (?:_assertThisInitialized\()*(\w+)\)*;/)[1]; eval(`${thisName} = this;`); } thirdCtor.call(this);
    }
...
test('dynamic method names and super', () => {
  let cls; let cls1; let method; let
    method1;
  let method2; let
    method3;
  class Base {
