...
var o = function o(patternString, action, options) {
  var match = void 0;
  ...
  var addLocationDataFn = function addLocationDataFn(first, last) {
    if (!last) {
...
var grammar = {
  ...
  AssignObj: [o('ObjAssignable', function () {
    ...
    return new Assign(LOC(1)(new Value($1)), $3, 'object', { operatorToken: LOC(2)(new Literal($2)) });
  }), o('ObjAssignable : \
INDENT Expression OUTDENT', function () {
    return new Assign(LOC(1)(new Value($1)), $4, 'object', { operatorToken: LOC(2)(new Literal($2)) });
  }), o('SimpleObjAssignable = Expression', function () {
    return new Assign(LOC(1)(new Value($1)), $3, null, { operatorToken: LOC(2)(new Literal($2)) });
  }), o('SimpleObjAssignable = \
INDENT Expression OUTDENT', function () {
    return new Assign(LOC(1)(new Value($1)), $4, null, { operatorToken: LOC(2)(new Literal($2)) });
  }), o('Comment')],
  ...
  Export: [o('EXPORT { }', function () {
    ...
    return new ExportNamedDeclaration(new Assign($2, $4, null, { moduleDeclaration: 'export' }));
  }), o('EXPORT Identifier = TERMINATOR Expression', function () {
    return new ExportNamedDeclaration(new Assign($2, $5, null, { moduleDeclaration: 'export' }));
  ...
  WhileSource: [o('WHILE Expression', function () {
    ...
    return new While($2, { guard: $4 });
  }), o('UNTIL Expression', function () {
    return new While($2, { invert: true });
  }), o('UNTIL Expression WHEN Expression', function () {
    return new While($2, { invert: true, guard: $4 });
  })],
  ...
  ForBody: [o('FOR Range', function () {
    ...
    $2.own = $1.own;$2.ownTag = $1.ownTag;$2.name = $1[0];$2.index = $1[1];return $2;
  })],

  ForStart: [o('FOR ForVariables', function () {
    return $2;
  }), o('FOR OWN ForVariables', function () {
    $3.own = true;$3.ownTag = LOC(2)(new Literal($2));return $3;
  })],
  ...
  IfBlock: [o('IF Expression Block', function () {
    return new If($2, $3, { type: $1 });
  }), o('IfBlock ELSE IF Expression Block', function () {
    return $1.addElse(LOC(3, 5)(new If($4, $5, { type: $3 })));
  })],
  ...
  If: [o('IfBlock'), o('IfBlock ELSE Block', function () {
    ...
    return new If($3, LOC(1)(Block.wrap([$1])), { type: $2, statement: true });
  ...
  Operation: [o('UNARY Expression', function () {
    ...
    return new Op('-', $2);
  }, { prec: 'UNARY_MATH' }), o('+     Expression', function () {
    return new Op('+', $2);
  }, { prec: 'UNARY_MATH' }), o('-- SimpleAssignable', function () {
    return new Op('--', $2);
...
//
//     (2 + 3) * 4
var operators = [['left', '.', '?.', '::', '?::'], ['left', 'CALL_START', 'CALL_END'], ['nonassoc', '++', '--'], ['left', '?'], ['right', 'UNARY'], ['right', '**'], ['right', 'UNARY_MATH'], ['left', 'MATH'], ['left', '+', '-'], ['left', 'SHIFT'], ['left', 'RELATION'], ['left', 'COMPARE'], ['left', '&'], ['left', '^'], ['left', '|'], ['left', '&&'], ['left', '||'], ['left', 'BIN?'], ['nonassoc', 'INDENT', 'OUTDENT'], ['right', 'YIELD'], ['right', '=', ':', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS'], ['right', 'FORIN', 'FOROF', 'FORFROM', 'BY', 'WHEN'], ['right', 'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS', 'IMPORT', 'EXPORT'], ['left', 'POST_IF']];
...
for (var name in grammar) {
  ...
  grammar[name] = function () {
    ...
    try {
      for (var _iterator = Array.from(alternatives)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var alt = _step.value;
        ...
        try {
          for (var _iterator2 = Array.from(alt[0].split(' '))[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
